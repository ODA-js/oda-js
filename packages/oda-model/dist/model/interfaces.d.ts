...
export declare type RelationType = 'HasMany' | 'HasOne' | 'BelongsToMany' | 'BelongsTo';
export declare type MetaModelType = 'model' | 'package' | 'entity' | 'entitybase' | 'object-type' | 'scalar' | 'mixin' | 'union' | 'enum' | 'field' | 'relation' | 'operation' | 'ref' | RelationType;
...
export declare type ModelItem = IModel | IPackage | IEntity | IField | IRelation;
export declare type Relation = IHasManyRelation | IHasOneRelation | IBelongsToRelation | IBelongsToRelation;
export declare function isModel(item: ModelItem): item is IModel;
export declare function isPackage(item: ModelItem): item is IPackage;
export declare function isEntity(item: ModelItem): item is IEntity;
export declare function isField(item: ModelItem): item is IField;
export declare function isRelation(item: ModelItem): item is IRelation;
export declare function IsBelongsTo(item: Relation): item is IBelongsToRelation;
export declare function IsBelongsToMany(item: Relation): item is IBelongsToRelation;
export declare function IsHasOne(item: Relation): item is IBelongsToRelation;
export declare function IsHasMany(item: Relation): item is IBelongsToRelation;
export declare type ValidationResultType = 'error' | 'warning' | 'critics' | 'fixable';
...
export declare type FieldType = string | ComplextType;
